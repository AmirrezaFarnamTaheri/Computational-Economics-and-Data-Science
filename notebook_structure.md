...
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 27 Markdown
- **Content**: 8645 words, 246 lines of code
- **Richness**: 108 equations, 15 images, 31 links

### Features
Widgets, Theorems, Examples, History, Concepts

**Libraries**: matplotlib, numpy, seaborn, statsmodels
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 24 Markdown
- **Content**: 6930 words, 38 lines of code
- **Richness**: 9 equations, 6 images, 17 links

### Features
Widgets, Examples, Exercises, History, Concepts

**Libraries**: matplotlib, numpy, pandas, scipy, seaborn
...
### Overview
- **Kernel**: Python 3
- **Cells**: 18 Code, 28 Markdown
- **Content**: 3467 words, 380 lines of code
- **Richness**: 6 equations, 10 images, 35 links

### Features
Exercises, Concepts

**Libraries**: copy, decimal, gc, math, matplotlib, numpy, seaborn, sys, typing
...
### Overview
- **Kernel**: Python 3
- **Cells**: 16 Code, 22 Markdown
- **Content**: 2326 words, 446 lines of code
- **Richness**: 0 equations, 5 images, 18 links

### Features
Exercises

**Libraries**: abc, collections, contextlib, functools, matplotlib, numpy, pandas, seaborn, sys, time
...
### Overview
- **Kernel**: Python 3
- **Cells**: 14 Code, 39 Markdown
- **Content**: 3620 words, 270 lines of code
- **Richness**: 0 equations, 8 images, 29 links

### Features
Exercises, History, Concepts

**Libraries**: array, bisect, collections, copy, math, matplotlib, numpy, operator, seaborn, sys, timeit, typing
...
### Overview
- **Kernel**: Python 3
- **Cells**: 8 Code, 18 Markdown
- **Content**: 1549 words, 151 lines of code
- **Richness**: 1 equations, 4 images, 15 links

### Features
Exercises, Concepts

**Libraries**: matplotlib, numpy, re, seaborn, sys, timeit, unicodedata
...
### Overview
- **Kernel**: Python 3
- **Cells**: 13 Code, 21 Markdown
- **Content**: 2703 words, 251 lines of code
- **Richness**: 0 equations, 6 images, 26 links

### Features
Exercises

**Libraries**: collections, json, math, matplotlib, numpy, random, seaborn, sys, timeit, types
...
### Overview
- **Kernel**: Python 3
- **Cells**: 8 Code, 14 Markdown
- **Content**: 1602 words, 139 lines of code
- **Richness**: 0 equations, 5 images, 18 links

### Features
Exercises, Concepts

**Libraries**: itertools, matplotlib, pandas, random, seaborn, sys, timeit
...
### Overview
- **Kernel**: Python 3
- **Cells**: 12 Code, 18 Markdown
- **Content**: 2301 words, 246 lines of code
- **Richness**: 0 equations, 5 images, 21 links

### Features
Widgets, Exercises, History, Concepts

**Libraries**: contextlib, itertools, math, matplotlib, numpy, seaborn, sys, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 11 Code, 14 Markdown
- **Content**: 2329 words, 303 lines of code
- **Richness**: 0 equations, 6 images, 19 links

### Features
Exercises, History, Concepts

**Libraries**: functools, math, matplotlib, numpy, operator, pandas, random, scipy, seaborn, sys, time, typing, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 7 Code, 15 Markdown
- **Content**: 2239 words, 310 lines of code
- **Richness**: 0 equations, 6 images, 19 links

### Features
Exercises, Concepts

**Libraries**: abc, attrs, dataclasses, math, matplotlib, numpy, seaborn, sys, time, typing, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 15 Code, 25 Markdown
- **Content**: 2449 words, 289 lines of code
- **Richness**: 15 equations, 5 images, 28 links

### Features
Exercises, Concepts

**Libraries**: cProfile, json, math, matplotlib, numpy, os, pandas, pstats, random, scipy, sys, time, timeit, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 11 Code, 17 Markdown
- **Content**: 1496 words, 210 lines of code
- **Richness**: 0 equations, 4 images, 17 links

### Features
Exercises

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 16 Markdown
- **Content**: 1157 words, 153 lines of code
- **Richness**: 0 equations, 4 images, 18 links

### Features
Exercises

**Libraries**: bs4, json, math, matplotlib, numpy, os, pandas, playwright, random, re, requests, seaborn, sys, textwrap, time, warnings
...
- **Kernel**: Python 3
- **Cells**: 8 Code, 14 Markdown
- **Content**: 787 words, 135 lines of code
- **Richness**: 0 equations, 4 images, 17 links

### Features
Examples, Exercises, History

**Libraries**: IPython, datetime, fredapi, json, math, matplotlib, numpy, os, pandas, random, requests, seaborn, sys, time, warnings, wbdata
...
### Overview
- **Kernel**: Python 3
- **Cells**: 7 Code, 13 Markdown
- **Content**: 1391 words, 157 lines of code
- **Richness**: 0 equations, 5 images, 16 links

### Features
Widgets, Exercises

**Libraries**: IPython, altair, json, math, matplotlib, numpy, os, pandas, plotnine, random, seaborn, sys, textwrap, time, vega_datasets, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 9 Code, 18 Markdown
- **Content**: 1891 words, 239 lines of code
- **Richness**: 4 equations, 4 images, 15 links

### Features
Widgets, Examples, Exercises

**Libraries**: IPython, json, logging, math, matplotlib, numpy, os, pandas, pytest, random, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 9 Markdown
- **Content**: 651 words, 108 lines of code
- **Richness**: 0 equations, 4 images, 14 links

### Features
Exercises

**Libraries**: bs4, json, math, matplotlib, numpy, os, pandas, playwright, random, requests, seaborn, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 11 Markdown
- **Content**: 666 words, 104 lines of code
- **Richness**: 0 equations, 4 images, 13 links

### Features
Exercises

**Libraries**: json, math, matplotlib, numpy, os, pandas, random, seaborn, sqlite3, sys, textwrap, time, warnings
...
- **Kernel**: Python 3
- **Cells**: 7 Code, 13 Markdown
- **Content**: 670 words, 96 lines of code
- **Richness**: 13 equations, 4 images, 15 links

### Features
Exercises

**Libraries**: json, math, matplotlib, numpy, os, pandas, random, scipy, seaborn, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 7 Code, 12 Markdown
- **Content**: 557 words, 115 lines of code
- **Richness**: 12 equations, 4 images, 17 links

### Features
Exercises, Concepts

**Libraries**: json, math, matplotlib, numpy, os, pandas, random, seaborn, sympy, sys, textwrap, time, warnings
...
---
## ./01-Foundations/22_Computational_Complexity.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 9 Markdown
- **Content**: 936 words, 80 lines of code
- **Richness**: 12 equations, 4 images, 14 links

### Features
Exercises

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, seaborn, sys, textwrap, time, timeit, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 10 Markdown
- **Content**: 512 words, 77 lines of code
- **Richness**: 0 equations, 4 images, 12 links

### Features
Exercises

**Libraries**: IPython, json, math, matplotlib, numba, numpy, os, pandas, random, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 2 Code, 8 Markdown
- **Content**: 817 words, 50 lines of code
- **Richness**: 0 equations, 4 images, 10 links

### Features
Widgets, Exercises, Concepts

**Libraries**: IPython, json, logging, math, matplotlib, numpy, os, pandas, random, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 7 Code, 24 Markdown
- **Content**: 2458 words, 153 lines of code
- **Richness**: 95 equations, 12 images, 12 links

### Features
Proofs, Exercises

**Libraries**: IPython, json, math, matplotlib, mpl_toolkits, numpy, os, pandas, random, scipy, seaborn, sympy, sys, textwrap, time, timeit, warnings
...
### Proof: `solve` is Superior to `inv`
#### Application: The Leontief Input-Output Model
### Solving the Leontief Input-Output Model
...
### Memory and Speed of Sparse Matrices
# Summary
## Exercises
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 23 Markdown
- **Content**: 1689 words, 104 lines of code
- **Richness**: 25 equations, 8 images, 25 links

### Features
Exercises, Concepts

**Libraries**: decimal, json, math, matplotlib, numpy, os, pandas, random, scipy, seaborn, struct, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 18 Markdown
- **Content**: 1687 words, 125 lines of code
- **Richness**: 49 equations, 6 images, 19 links

### Features
Exercises

**Libraries**: jax, json, math, matplotlib, mpl_toolkits, numpy, os, pandas, random, scipy, seaborn, sympy, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 19 Markdown
- **Content**: 1736 words, 84 lines of code
- **Richness**: 82 equations, 6 images, 19 links

### Features
Theorems, Exercises

**Libraries**: json, math, matplotlib, numpy, os, pandas, random, scipy, seaborn, sys, textwrap, time, typing, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 7 Code, 30 Markdown
- **Content**: 2130 words, 174 lines of code
- **Richness**: 58 equations, 5 images, 20 links

### Features
Exercises

**Libraries**: cvxpy, jax, json, math, matplotlib, mpl_toolkits, numpy, os, pandas, random, scipy, seaborn, sys, textwrap, time, timeit, typing, warnings
...
- **Kernel**: Python 3
- **Cells**: 3 Code, 19 Markdown
- **Content**: 1514 words, 69 lines of code
- **Richness**: 29 equations, 8 images, 19 links

### Features
Theorems, Exercises

**Libraries**: itertools, json, math, matplotlib, mpl_toolkits, numpy, os, pandas, random, scipy, seaborn, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 2 Code, 19 Markdown
- **Content**: 1474 words, 41 lines of code
- **Richness**: 46 equations, 7 images, 19 links
...
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 17 Markdown
- **Content**: 1540 words, 126 lines of code
- **Richness**: 44 equations, 6 images, 18 links

### Features
Exercises

**Libraries**: jax, json, math, matplotlib, numpy, os, pandas, pathlib, plotting_utils, random, scipy, seaborn, sys, textwrap, time, typing, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 11 Code, 28 Markdown
- **Content**: 1907 words, 310 lines of code
- **Richness**: 76 equations, 6 images, 15 links

### Features
Exercises

**Libraries**: IPython, json, math, matplotlib, numba, numpy, os, pandas, plotly, random, scipy, seaborn, sys, textwrap, time, typing, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 7 Code, 19 Markdown
- **Content**: 1862 words, 218 lines of code
- **Richness**: 67 equations, 6 images, 16 links

### Features
Exercises

**Libraries**: IPython, json, math, matplotlib, numba, numpy, os, pandas, random, scipy, seaborn, sys, textwrap, time, warnings
...
---
## ./03-Economic-Modeling/03_Discrete_Continuous_DP.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 7 Markdown
- **Content**: 668 words, 174 lines of code
- **Richness**: 26 equations, 4 images, 9 links

### Features
None detected

**Libraries**: IPython, matplotlib, numpy, pandas, scipy, seaborn
...
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 7 Markdown
- **Content**: 538 words, 220 lines of code
- **Richness**: 12 equations, 6 images, 6 links

### Features
Exercises

**Libraries**: math, matplotlib, numba, numpy, os, pandas, scipy, sys, warnings

### Outline
# 04 Estimation and Calibration
## Chapter 3.04
# The Lens: From Theory to Reality
## 1. The Method of Moments Framework
### 1.1 Identification
...
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 11 Markdown
- **Content**: 1411 words, 76 lines of code
- **Richness**: 51 equations, 4 images, 14 links

### Features
Exercises

**Libraries**: IPython, json, math, matplotlib, numba, numpy, os, pandas, random, scipy, sys, textwrap, time, typing, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 2 Code, 13 Markdown
- **Content**: 1588 words, 54 lines of code
- **Richness**: 42 equations, 4 images, 14 links

### Features
Exercises

**Libraries**: json, math, matplotlib, mpl_toolkits, numba, numpy, os, pandas, random, scipy, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 15 Markdown
- **Content**: 1635 words, 114 lines of code
- **Richness**: 47 equations, 4 images, 17 links

### Features
Exercises

**Libraries**: IPython, graphviz, json, math, matplotlib, numpy, os, pandas, random, scipy, seaborn, statsmodels, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 17 Markdown
- **Content**: 1654 words, 132 lines of code
- **Richness**: 60 equations, 4 images, 11 links

### Features
Exercises, Concepts

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, scipy, seaborn, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 13 Markdown
- **Content**: 1349 words, 178 lines of code
- **Richness**: 46 equations, 2 images, 14 links

### Features
Exercises

**Libraries**: IPython, json, math, matplotlib, mpl_toolkits, numba, numpy, os, pandas, random, scipy, seaborn, sys, textwrap, time, warnings
...
- **Kernel**: Python 3
- **Cells**: 3 Code, 9 Markdown
- **Content**: 760 words, 300 lines of code
- **Richness**: 35 equations, 4 images, 4 links

### Features
None detected

**Libraries**: IPython, json, macro_utils, math, matplotlib, numpy, os, pandas, random, scipy, sys, textwrap, time, warnings

### Outline
# 03 Real Business Cycle (RBC) Models
# 03_RBC_Models
...
## 2. Solving the Model: Log-Linearization and QZ Decomposition
### 3. Analyzing Dynamics: Surprise vs. News Shocks
...
- **Kernel**: Python 3
- **Cells**: 3 Code, 11 Markdown
- **Content**: 1333 words, 115 lines of code
- **Richness**: 17 equations, 2 images, 14 links

### Features
Exercises

**Libraries**: IPython, json, math, matplotlib, mpl_toolkits, numpy, os, pandas, random, scipy, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 13 Markdown
- **Content**: 1553 words, 101 lines of code
- **Richness**: 43 equations, 2 images, 14 links

### Features
Exercises

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, scipy, sys, textwrap, time, warnings
...
- **Kernel**: Python 3
- **Cells**: 3 Code, 11 Markdown
- **Content**: 1284 words, 90 lines of code
- **Richness**: 11 equations, 2 images, 12 links

### Features
Exercises

**Libraries**: IPython, json, math, matplotlib, numba, numpy, os, pandas, random, scipy, sys, textwrap, time, warnings
...
---
## ./04-Macro-Models/08_Endogenous_Growth.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 2 Code, 13 Markdown
- **Content**: 1656 words, 40 lines of code
- **Richness**: 55 equations, 2 images, 12 links

### Features
Widgets, Exercises

**Libraries**: IPython, ipywidgets, json, math, matplotlib, numpy, os, pandas, random, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 16 Markdown
- **Content**: 1478 words, 91 lines of code
- **Richness**: 42 equations, 4 images, 18 links

### Features
Exercises, Concepts

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, scipy, seaborn, sympy, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 6 Markdown
- **Content**: 560 words, 234 lines of code
- **Richness**: 25 equations, 6 images, 6 links

### Features
None detected

**Libraries**: matplotlib, numpy, os, pandas, scipy, sys, warnings

### Outline
# 02 General Equilibrium
## Chapter 5.02
# The Lens: The Invisible Hand Calculated
## 1. The Computable General Equilibrium (CGE) Framework
### 1.1 The Model Equations
## 2. The Heckscher-Ohlin Model of Trade
### 2.1 Visualizing World Equilibrium
# Summary
...
### Overview
- **Kernel**: Python 3
- **Cells**: 12 Code, 22 Markdown
- **Content**: 1769 words, 283 lines of code
- **Richness**: 12 equations, 6 images, 12 links

### Features
Exercises, Concepts

**Libraries**: IPython, itertools, json, math, matplotlib, nashpy, numpy, os, pandas, random, scipy, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 21 Markdown
- **Content**: 1722 words, 61 lines of code
- **Richness**: 43 equations, 6 images, 20 links

### Features
Examples, Exercises

**Libraries**: IPython, arviz, collections, json, math, matplotlib, numpy, os, pandas, pylogit, pymc, pytensor, random, scipy, seaborn, sys, textwrap, time, warnings
...
- **Kernel**: Python 3
- **Cells**: 5 Code, 17 Markdown
- **Content**: 1354 words, 80 lines of code
- **Richness**: 19 equations, 6 images, 16 links

### Features
Widgets, Exercises

**Libraries**: IPython, ipywidgets, json, math, matplotlib, numpy, os, pandas, random, scipy, sys, textwrap, time, warnings
...
- **Kernel**: Python 3
- **Cells**: 3 Code, 17 Markdown
- **Content**: 1561 words, 107 lines of code
- **Richness**: 5 equations, 6 images, 17 links
...
### Overview
- **Kernel**: Python 3
- **Cells**: 8 Code, 17 Markdown
- **Content**: 1360 words, 280 lines of code
- **Richness**: 58 equations, 4 images, 18 links

### Features
Theorems, Exercises

**Libraries**: IPython, json, math, matplotlib, mpl_toolkits, numpy, os, pandas, random, seaborn, sklearn, statsmodels, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 9 Markdown
- **Content**: 636 words, 218 lines of code
- **Richness**: 29 equations, 6 images, 17 links

### Features
Examples

**Libraries**: IPython, json, math, matplotlib, mpl_toolkits, numpy, os, pandas, random, scipy, statsmodels, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Unknown
- **Cells**: 9 Code, 19 Markdown
- **Content**: 1339 words, 94 lines of code
- **Richness**: 28 equations, 6 images, 7 links

### Features
Exercises, Concepts

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, seaborn, statsmodels, sys, textwrap, time, warnings
...
## Table of Contents
## Part 6: Econometrics
## Chapter 6.03: Causal Inference: The Quest for "Why"
...
### Overview
- **Kernel**: Python 3
- **Cells**: 10 Code, 24 Markdown
- **Content**: 3126 words, 244 lines of code
- **Richness**: 145 equations, 9 images, 23 links

### Features
Examples, Exercises, Concepts

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, scipy, statsmodels, sys, textwrap, time, warnings
...
- **Kernel**: Unknown
- **Cells**: 8 Code, 18 Markdown
- **Content**: 1195 words, 161 lines of code
- **Richness**: 58 equations, 6 images, 7 links

### Features
Widgets, Examples, Exercises

**Libraries**: IPython, ipywidgets, json, linearmodels, math, matplotlib, networkx, numpy, os, pandas, random, statsmodels, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 17 Markdown
- **Content**: 1213 words, 95 lines of code
- **Richness**: 33 equations, 6 images, 7 links

### Features
Widgets, Examples

**Libraries**: IPython, ipywidgets, json, linearmodels, math, matplotlib, numpy, os, pandas, random, seaborn, statsmodels, sys, textwrap, time, warnings
...
- **Kernel**: Python 3
- **Cells**: 5 Code, 17 Markdown
- **Content**: 1580 words, 104 lines of code
- **Richness**: 13 equations, 8 images, 20 links

### Features
Exercises, History

**Libraries**: matplotlib, numpy, pandas, pysinc, seaborn
...
### Overview
- **Kernel**: Python 3
- **Cells**: 7 Code, 16 Markdown
- **Content**: 1386 words, 121 lines of code
- **Richness**: 39 equations, 6 images, 7 links

### Features
Examples

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, sklearn, statsmodels, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Unknown
- **Cells**: 15 Code, 34 Markdown
- **Content**: 1469 words, 160 lines of code
- **Richness**: 31 equations, 6 images, 7 links

### Features
Examples, History

**Libraries**: IPython, arch, json, math, matplotlib, numpy, os, pandas, pandas_datareader, random, seaborn, statsmodels, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 15 Markdown
- **Content**: 986 words, 41 lines of code
- **Richness**: 38 equations, 6 images, 7 links

### Features
Examples, Exercises, History

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, statsmodels, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 12 Markdown
- **Content**: 1961 words, 171 lines of code
- **Richness**: 47 equations, 6 images, 6 links

### Features
Theorems, Exercises, Concepts

**Libraries**: IPython, arviz, econometrics_utils, json, math, matplotlib, numpy, os, pandas, pymc, random, scipy, seaborn, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 8 Code, 24 Markdown
- **Content**: 1880 words, 132 lines of code
- **Richness**: 66 equations, 6 images, 7 links

### Features
Exercises

**Libraries**: IPython, json, linearmodels, math, matplotlib, numpy, os, pandas, random, seaborn, statsmodels, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 7 Code, 11 Markdown
- **Content**: 1168 words, 281 lines of code
- **Richness**: 38 equations, 4 images, 17 links

### Features
Exercises, History

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, seaborn, sklearn, statsmodels, sys, textwrap, time, warnings

### Outline
# 01 Introduction to ML for Economists
## Part 7: Machine Learning
## Chapter 7.01: Introduction to Machine Learning for Economists
### Table of Contents
...
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 11 Markdown
- **Content**: 505 words, 85 lines of code
- **Richness**: 0 equations, 7 images, 12 links

### Features
History

**Libraries**: IPython, matplotlib, numpy, os, sklearn, xgboost
...
- **Kernel**: Python 3
- **Cells**: 7 Code, 15 Markdown
- **Content**: 795 words, 73 lines of code
- **Richness**: 0 equations, 6 images, 12 links

### Features
History, Concepts

**Libraries**: IPython, matplotlib, mpl_toolkits, numpy, os, sklearn
...
- **Kernel**: Python 3
- **Cells**: 7 Code, 15 Markdown
- **Content**: 751 words, 48 lines of code
- **Richness**: 0 equations, 9 images, 15 links

### Features
History

**Libraries**: IPython, matplotlib, numpy, sklearn
...
### Overview
- **Kernel**: Python 3
- **Cells**: 20 Code, 41 Markdown
- **Content**: 2527 words, 158 lines of code
- **Richness**: 33 equations, 6 images, 23 links

### Features
Examples, Exercises, Concepts

**Libraries**: IPython, matplotlib, numpy, os, pandas, seaborn, sklearn
...
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 6 Markdown
- **Content**: 342 words, 135 lines of code
- **Richness**: 0 equations, 6 images, 10 links

### Features
History, Concepts

**Libraries**: IPython, graphviz, json, math, matplotlib, numpy, os, pandas, random, shap, sklearn, sys, tensorflow, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 14 Markdown
- **Content**: 758 words, 37 lines of code
- **Richness**: 0 equations, 7 images, 14 links

### Features
None detected

**Libraries**: IPython, matplotlib, numpy, tensorflow
...
### Overview
- **Kernel**: Python 3
- **Cells**: 9 Code, 27 Markdown
- **Content**: 2052 words, 138 lines of code
- **Richness**: 54 equations, 7 images, 20 links

### Features
Examples, Exercises, Concepts

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, seaborn, sklearn, sys, tensorflow, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 9 Code, 26 Markdown
- **Content**: 2023 words, 154 lines of code
- **Richness**: 59 equations, 8 images, 21 links
...
# 09 LSTMs and GRUs
# The Lens
## Chapter 7.4: LSTMs and GRUs: Architectures for Long-Term Memory
### Table of Contents
...
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 22 Markdown
- **Content**: 2084 words, 100 lines of code
- **Richness**: 37 equations, 7 images, 19 links

### Features
Examples, Exercises, Concepts

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, seaborn, sys, tensorflow, textwrap, time, warnings
...
---
## ./07-Machine-Learning/10_Transformers_executed.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 22 Markdown
- **Content**: 2085 words, 102 lines of code
- **Richness**: 37 equations, 7 images, 19 links
...
- **Kernel**: Python 3
- **Cells**: 5 Code, 15 Markdown
- **Content**: 661 words, 150 lines of code
- **Richness**: 0 equations, 8 images, 13 links

### Features
Concepts

**Libraries**: IPython, matplotlib, numpy, os, tensorflow, torch
...
### Overview
- **Kernel**: Unknown
- **Cells**: 7 Code, 23 Markdown
- **Content**: 2070 words, 148 lines of code
- **Richness**: 33 equations, 8 images, 19 links

### Features
Exercises, Concepts

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, random, sys, tensorflow, textwrap, time, warnings

### Outline
# 12 Self Supervised Learning
# The Lens
## Chapter 7.6: Self-Supervised Representation Learning
### Table of Contents
...
- **Kernel**: Python 3
- **Cells**: 8 Code, 18 Markdown
- **Content**: 1013 words, 213 lines of code
- **Richness**: 14 equations, 6 images, 17 links
...
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 16 Markdown
- **Content**: 920 words, 55 lines of code
- **Richness**: 0 equations, 6 images, 15 links
...
### Overview
- **Kernel**: Python 3
- **Cells**: 10 Code, 21 Markdown
- **Content**: 2335 words, 152 lines of code
- **Richness**: 89 equations, 6 images, 19 links

### Features
Theorems, Proofs, Exercises, Concepts

**Libraries**: IPython, collections, gymnasium, json, math, matplotlib, numpy, os, pandas, random, sys, tensorflow, textwrap, time, warnings

### Outline
# 15 Reinforcement Learning
# The Lens
## Chapter 7.8: Reinforcement Learning: Learning from Interaction
### Table of Contents
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 18 Markdown
- **Content**: 1787 words, 133 lines of code
- **Richness**: 66 equations, 6 images, 7 links

### Features
Theorems, Exercises, History, Concepts

**Libraries**: IPython, collections, gymnasium, json, math, matplotlib, numpy, os, pandas, random, sys, textwrap, time, torch, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 12 Code, 28 Markdown
- **Content**: 3536 words, 172 lines of code
- **Richness**: 99 equations, 7 images, 21 links

### Features
Theorems, Exercises, Concepts

**Libraries**: IPython, doubleml, econml, graphviz, json, math, matplotlib, mpl_toolkits, numpy, os, pandas, random, seaborn, sklearn, statsmodels, sys, textwrap, time, warnings
...
### Visualizing the Frisch-Waugh-Lovell Theorem
...
- **Kernel**: Python 3
- **Cells**: 8 Code, 24 Markdown
- **Content**: 1015 words, 78 lines of code
- **Richness**: 5 equations, 8 images, 9 links

### Features
Concepts

**Libraries**: IPython, gensim, graphviz, json, math, matplotlib, nltk, numpy, os, pandas, random, re, seaborn, sklearn, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 1 Code, 10 Markdown
- **Content**: 643 words, 21 lines of code
- **Richness**: 0 equations, 9 images, 14 links

### Features
Exercises

**Libraries**: matplotlib, networkx, seaborn
...
### Overview
- **Kernel**: Python 3
- **Cells**: 9 Code, 22 Markdown
- **Content**: 1652 words, 139 lines of code
- **Richness**: 1 equations, 6 images, 7 links

### Features
Exercises, History, Concepts

**Libraries**: IPython, esda, geodatasets, geopandas, json, libpysal, mapclassify, math, matplotlib, numpy, os, pandas, random, shapely, splot, sys, textwrap, time, warnings
...
## Chapter 7.10: Geospatial Data Analysis
# Introduction
...
- **Kernel**: Python 3
- **Cells**: 5 Code, 13 Markdown
- **Content**: 704 words, 226 lines of code
- **Richness**: 1 equations, 6 images, 7 links

### Features
History

**Libraries**: IPython, matplotlib, numpy, pandas, pandas_datareader, seaborn, sklearn, statsmodels
...
### Overview
- **Kernel**: Unknown
- **Cells**: 7 Code, 21 Markdown
- **Content**: 817 words, 169 lines of code
- **Richness**: 6 equations, 6 images, 7 links
...
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 12 Markdown
- **Content**: 1869 words, 93 lines of code
- **Richness**: 58 equations, 5 images, 13 links

### Features
Theorems, Exercises, History, Concepts

**Libraries**: IPython, matplotlib, numpy, pandas, seaborn, statsmodels
...
### Overview
- **Kernel**: Python 3
- **Cells**: 18 Code, 31 Markdown
- **Content**: 2555 words, 193 lines of code
- **Richness**: 76 equations, 7 images, 18 links

### Features
Examples, Exercises, Concepts

**Libraries**: IPython, matplotlib, numpy, pandas, pandas_datareader, statsmodels
...
### Overview
- **Kernel**: Python 3
- **Cells**: 21 Code, 31 Markdown
- **Content**: 2499 words, 137 lines of code
- **Richness**: 18 equations, 7 images, 20 links

### Features
Exercises, Concepts

**Libraries**: IPython, logging, matplotlib, numpy, pandas, pandas_datareader, prophet, sklearn, statsmodels
...
### Overview
- **Kernel**: Python 3
- **Cells**: 2 Code, 9 Markdown
- **Content**: 1349 words, 46 lines of code
- **Richness**: 36 equations, 7 images, 16 links

### Features
Concepts

**Libraries**: matplotlib, numpy, os, pandas, pandas_datareader, seaborn, statsmodels, sys

### Outline
# 04 Vector Autoregression
...
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 8 Markdown
- **Content**: 482 words, 99 lines of code
- **Richness**: 14 equations, 6 images, 6 links

### Features
History

**Libraries**: arch, matplotlib, numpy, os, pandas, scipy, statsmodels, sys, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 15 Code, 23 Markdown
- **Content**: 1667 words, 105 lines of code
- **Richness**: 23 equations, 7 images, 14 links
...
---
## ./09-Finance/01_Financial_Frictions_BGG.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 14 Markdown
- **Content**: 926 words, 185 lines of code
- **Richness**: 29 equations, 4 images, 10 links

### Features
Concepts

**Libraries**: IPython, json, macro_utils, math, matplotlib, numpy, os, pandas, random, seaborn, sys, textwrap, time, warnings
...
### Concept Overview: Object-Oriented Programming (Classes)
### Concept Overview: Modular Functions
### Concept Overview: Pandas DataFrame
### Implementation Detail
### Implementation Detail
## Summary
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 20 Markdown
- **Content**: 937 words, 198 lines of code
- **Richness**: 11 equations, 4 images, 4 links

### Features
Concepts

**Libraries**: matplotlib, numpy, os, pandas, pypfopt, scipy, statsmodels, sys, warnings
...
## 4. Summary
# Summary
### Concept Overview: Anonymous Functions (Lambda)
### Concept Overview: Modular Functions
### Concept Overview: NumPy Arrays
### Concept Overview: Numerical Optimization
### Implementation Detail
## Summary

---
## ./09-Finance/03_Asset_Pricing.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 23 Markdown
- **Content**: 1486 words, 171 lines of code
- **Richness**: 45 equations, 2 images, 16 links

### Features
Exercises, Concepts

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, pandas_datareader, pathlib, random, re, seaborn, statsmodels, sys, textwrap, time, warnings, yfinance
...
---
## ./09-Finance/04_Option_Pricing.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 33 Markdown
- **Content**: 3290 words, 265 lines of code
- **Richness**: 90 equations, 4 images, 22 links

### Features
Exercises, Concepts

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, pathlib, random, scipy, seaborn, sys, textwrap, time, warnings, yfinance

### Outline
# 04 Option Pricing
### Concept Overview: Iterative Control Flow
### Concept Overview: Brent's Method
### Implementation Detail
## Part 9: Financial Economics
...
---
## ./09-Finance/05_Continuous_Time_Finance.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 25 Markdown
- **Content**: 2465 words, 187 lines of code
- **Richness**: 112 equations, 3 images, 18 links

### Features
Exercises, Concepts

**Libraries**: IPython, json, math, matplotlib, numpy, os, pandas, pathlib, random, seaborn, sympy, sys, textwrap, time, warnings

### Outline
# 05 Continuous Time Finance
### Concept Overview: Linear Algebra Solvers
### Implementation Detail
## Part 9: Financial Economics
## Chapter 9.5: Continuous-Time Finance and Dynamic Optimization
### Table of Contents
# The Lens: Calculus for Randomness
### 1. Introduction to Continuous Time
### 2. The Tools of Stochastic Calculus
#### Brownian Motion and Stochastic Differential Equations (SDEs)
...
---
## ./09-Finance/06_Credit_Risk.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 20 Markdown
- **Content**: 1444 words, 194 lines of code
- **Richness**: 41 equations, 2 images, 14 links
...
---
## ./09-Finance/07_High_Frequency_Data.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 15 Markdown
- **Content**: 1073 words, 114 lines of code
- **Richness**: 16 equations, 3 images, 9 links

### Features
Concepts

**Libraries**: json, math, matplotlib, numpy, os, pandas, random, seaborn, sys, textwrap, time, warnings

### Outline
# 07 High Frequency Data
### Implementation Detail
## Part 9: Financial Economics
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 28 Markdown
- **Content**: 2870 words, 395 lines of code
- **Richness**: 9 equations, 4 images, 19 links

### Features
Widgets, Exercises, Concepts

**Libraries**: IPython, dataclasses, ipywidgets, json, math, matplotlib, networkx, numpy, os, pandas, random, sys, textwrap, time, warnings

### Outline
# 01 Agent Based Models
### Concept Overview: Iterative Control Flow
### Implementation Detail
## Part 10: Specialized Models
...
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 26 Markdown
- **Content**: 2315 words, 164 lines of code
- **Richness**: 49 equations, 6 images, 13 links

### Features
Widgets, Exercises, History, Concepts

**Libraries**: IPython, ipywidgets, json, math, matplotlib, numba, numpy, os, pandas, random, scipy, sys, textwrap, time, warnings
...
### Concept Overview: Just-In-Time (JIT) Compilation
### Implementation Detail
...
### Overview
- **Kernel**: Python 3
- **Cells**: 6 Code, 25 Markdown
- **Content**: 2504 words, 209 lines of code
- **Richness**: 43 equations, 6 images, 19 links

### Features
Widgets, Exercises, History, Concepts

**Libraries**: IPython, ipywidgets, json, math, matplotlib, networkx, numpy, os, pandas, random, seaborn, sys, textwrap, time, warnings
...
---
## ./Appendix/01_Publishing_with_Quarto.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 3 Code, 16 Markdown
- **Content**: 1309 words, 35 lines of code
- **Richness**: 2 equations, 2 images, 4 links

### Features
Widgets, Exercises, Concepts

**Libraries**: json, math, matplotlib, numpy, os, pandas, pathlib, plotly, random, sys, textwrap, time, warnings
...
## Chapter 9.1: Building Professional Websites with Quarto
# Introduction
### Learning Objectives
...
---
## ./Appendix/01_Replication_Exercise_Chetty_2014.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 17 Markdown
- **Content**: 830 words, 61 lines of code
- **Richness**: 0 equations, 2 images, 4 links

### Features
Exercises, Concepts

**Libraries**: IPython, matplotlib, numpy, pandas, pathlib, seaborn, statsmodels
...
### Concept Overview: Split-Apply-Combine Strategy
### Implementation Detail
...
---
## ./Appendix/02_Autograding_with_Otter.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 18 Markdown
- **Content**: 1443 words, 47 lines of code
- **Richness**: 2 equations, 2 images, 4 links

### Features
Exercises, Concepts

**Libraries**: hypothesis, json, math, matplotlib, numpy, os, pandas, pathlib, random, sys, textwrap, time, warnings
...
### Overview
- **Kernel**: Python 3
- **Cells**: 44 Code, 69 Markdown
- **Content**: 3001 words, 111 lines of code
- **Richness**: 93 equations, 8 images, 15 links

### Features
Theorems, History, Concepts

**Libraries**: IPython, matplotlib, numpy, scipy, seaborn
...
### Concept Overview: Root-Finding Algorithms
## 1.4 Compactness
...
### Overview
- **Kernel**: Python 3
- **Cells**: 13 Code, 40 Markdown
- **Content**: 2069 words, 60 lines of code
- **Richness**: 59 equations, 4 images, 11 links
...
### Overview
- **Kernel**: Python 3
- **Cells**: 13 Code, 51 Markdown
- **Content**: 2125 words, 73 lines of code
- **Richness**: 53 equations, 10 images, 17 links
...
### Overview
- **Kernel**: Python 3
- **Cells**: 4 Code, 24 Markdown
- **Content**: 1374 words, 46 lines of code
- **Richness**: 52 equations, 3 images, 10 links
...
---
## ./high_performance_python/02_High_Performance_Computing.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 19 Markdown
- **Content**: 1501 words, 191 lines of code
- **Richness**: 12 equations, 2 images, 11 links

### Features
Concepts

**Libraries**: IPython, cProfile, cupy, dask, json, math, matplotlib, multiprocessing, numba, numpy, os, pandas, pstats, random, sys, textwrap, time, timeit, warnings
...
---
## ./high_performance_python/04_Accelerating_Code_with_Numba.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 5 Code, 16 Markdown
- **Content**: 957 words, 78 lines of code
- **Richness**: 8 equations, 2 images, 10 links

### Features
Examples, Concepts

**Libraries**: numba, numpy, random, timeit
...
---
## ./high_performance_python/05_Parallel_Computing_with_Dask.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 9 Code, 17 Markdown
- **Content**: 899 words, 60 lines of code
- **Richness**: 1 equations, 2 images, 8 links

### Features
Examples, Concepts

**Libraries**: dask, os, time, warnings
...
---
## ./high_performance_python/06_GPU_Acceleration_with_CuPy.ipynb
### Overview
- **Kernel**: Python 3
- **Cells**: 7 Code, 13 Markdown
- **Content**: 768 words, 70 lines of code
- **Richness**: 0 equations, 2 images, 8 links

### Features
Examples, Concepts

**Libraries**: cupy, numpy, timeit
