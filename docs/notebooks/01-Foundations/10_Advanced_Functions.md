...
8. [Freezing Arguments with `functools.partial`](#freezing-arguments-with-functoolspartial)
9. [Aggregating Sequences with `functools.reduce`](#aggregating-sequences-with-functoolsreduce)
10. [Summary](#summary)
