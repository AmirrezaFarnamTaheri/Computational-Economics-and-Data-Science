...
2. [The `ndarray`: Data Types, Memory, and Strides](#the-ndarray-data-types-memory-and-strides)
    ...
    - [Advanced Topic: Reshaping without Copying](#advanced-topic-reshaping-without-copying)
...
4. [Advanced Indexing](#advanced-indexing)
    ...
    - [Advanced Topic: Visualizing Broadcasting Rules](#advanced-topic-reshaping-without-copying)
