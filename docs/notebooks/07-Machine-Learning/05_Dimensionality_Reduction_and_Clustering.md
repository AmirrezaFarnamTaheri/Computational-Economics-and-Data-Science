...
1.  [**Introduction: The Curse of Dimensionality and Its Cures**](#1-introduction-the-curse-of-dimensionality-and-its-cures)
2.  [**Principal Component Analysis (PCA)**](#2-principal-component-analysis-pca)
    - [The Formal Definition of PCA](#21-the-formal-definition-of-pca)
    - [3.1 PCA from Scratch: The Eigenvalue Decomposition](#31-pca-from-scratch-the-eigenvalue-decomposition)
    - [The Connection to Singular Value Decomposition (SVD)](#22-the-connection-to-singular-value-decomposition-svd)
3.  [**Implementing PCA**](#3-implementing-pca)
    - [PCA from Scratch: A 2D Example](#pca-from-scratch-a-2d-example)
    - [Explained Variance and the Scree Plot](#scree-plot)
    - [Validating with Scikit-learn](#validating-with-scikit-learn)
4.  [**Applications of PCA**](#4-applications-of-pca)
    - [Application 1: Visualizing High-Dimensional Data](#application-1-visualizing-high-dimensional-data)
    - [Application 2: Building Statistical Factor Models in Finance](#application-2-building-statistical-factor-models-in-finance)
5.  [**A Brief Look at Non-Linear Techniques**](#5-a-brief-look-at-non-linear-techniques)
    - [t-SNE for Visualization](#t-sne-for-visualization)
    - [Autoencoders for Non-Linear Feature Extraction](#autoencoders-for-non-linear-feature-extraction)
