...
2.  [**Variational Autoencoders (VAEs)**](#2-variational-autoencoders-vaes)
    - [2.1 Architecture and Key Idea](#21-architecture-and-key-idea)
    - [The Reparameterization Trick](#22-the-reparameterization-trick)
    - [2.3 Code Lab: VAE for MNIST Generation](#23-code-lab-vae-for-mnist-generation)
3.  [**Generative Adversarial Networks (GANs)**](#3-generative-adversarial-networks-gans)
    - [3.1 Architecture and Key Idea](#31-architecture-and-key-idea)
    - [3.2 The Adversarial Training Process](#32-the-adversarial-training-process)
