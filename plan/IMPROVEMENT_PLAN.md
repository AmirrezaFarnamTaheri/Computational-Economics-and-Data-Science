...
*   **03A_RBC_Model_Foundations.ipynb** / **03B_RBC_Model_Solution.ipynb** / **03C_RBC_Dynamics_and_Surprise_Shocks.ipynb** / **03D_RBC_News_Shocks_and_Expectations.ipynb**
    *   *Action:* Expand content. Explicitly compare surprise vs. news shocks.
...
*   **02A_MLE_Principles_and_Geometry.ipynb** / **02B_MLE_Optimization_and_Applications.ipynb**
    *   *Action:* Keep MLE sequencing split across intuition/geometry (02A) and applied optimization (02B).
...
*   **04A_VAR_Estimation_and_Granger.ipynb** / **04B_VAR_Identification_and_Structural_Shocks.ipynb** / **04C_VAR_Impulse_Responses_and_FEVD.ipynb**
    *   *Action:* Focus on identification, IRFs, and variance decomposition. Differentiate from the structural approach in Module 06.

### Module 09: Finance
*Goal: Unify notation and make high-math concepts accessible.*

*   *Ordering:* Portfolio → Asset Pricing → Option Pricing → Continuous Time → Credit Risk → HFT → BGG.
