...
notebook_path = '08-Time-Series/04_Vector_Autoregression.ipynb'
old_markdown_substring = "![VAR Identification Diagram](images\\png\\var_identification_diagram.png)"
new_markdown_line = "![A diagram illustrating the VAR identification process, transforming correlated reduced-form residuals into uncorrelated structural shocks.](../images/08-Time-Series/var_identification_diagram.png)\\n"
