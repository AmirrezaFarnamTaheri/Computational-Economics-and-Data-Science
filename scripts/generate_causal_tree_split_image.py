...
def generate_causal_tree_image():
    ...
    dot.attr(
        label="Causal Tree Splitting Logic\\nMaximizing Treatment Effect Heterogeneity",
        fontsize="16",
        labelloc="t",
    )
...
if __name__ == "__main__":
    ...
    img_dir = os.path.join(
        os.path.dirname(__file__), "..", "images", "07-Machine-Learning", "causal_ml"
    )
