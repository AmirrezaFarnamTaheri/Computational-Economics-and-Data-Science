...
def generate_fama_macbeth_diagram():
    ...
    with dot.subgraph(name="cluster_pass1") as c:
        c.attr(
            label="Pass 1: Time-Series Regressions (run for each asset N)",
            style="rounded",
            color="blue",
            fontname="Helvetica",
            fontsize="12",
    ...
    with dot.subgraph(name="cluster_pass2") as c:
        c.attr(
            label="Pass 2: Cross-Sectional Regressions (run for each time period T)",
            style="rounded",
            color="green",
            fontname="Helvetica",
            fontsize="12",
    ...
    with dot.subgraph(name="cluster_final") as c:
        c.attr(
            label="Final Step: Test Significance",
            style="rounded",
            color="purple",
            fontname="Helvetica",
            fontsize="12",
    ...
    print(
        "Diagram 'images/09-Finance/fama_macbeth_procedure.png' created successfully."
    )
