...
def fix_notebook_20_syntax_v2(notebook_path):
        ...
        if cell['cell_type'] == 'code':
            ...
            for line in source:
                if "ylabel='Spatially Lagged Log GDP per Capita (Neighbors' Average)'" in line:
                    # The problematic string is inside single quotes, and contains a single quote.
...
if __name__ == '__main__':
    fix_notebook_20_syntax_v2('07-Machine-Learning/20_Geospatial_Data.ipynb')
