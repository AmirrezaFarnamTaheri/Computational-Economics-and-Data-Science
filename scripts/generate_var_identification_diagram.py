...
def generate_var_identification_diagram():
    ...
    dot.render(
        "images/var_identification_diagram", format="png", view=False, cleanup=True
    )
    print(
        "Diagram 'images/08-Time-Series/var_identification_diagram.png' created successfully."
    )
